...
Alt programmel er skrevet i programmeringssproget Python version 2.7. Til det er biblioteket OpenCV, anvendt, til standart billedbehandlings operationer b.la. at læse, vise og gemme billeder. Udover det er biblioteket NumPy anvendt, til at håndtere billederne og andre strukturer. Relevant programmel er tilføjet i afsnit \ref{sec:app}.
