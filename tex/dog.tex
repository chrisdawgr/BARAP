...
\begin{figure}[H]
    ...
    \label{fig:difference}
     ...
     \vspace{-2.5em}
  \end{figure} \noindent    
Da $LoG$ svare til sporret af hessian matricen, som angiver summen af hessian matricens egenværdier. vil et positivt filtersvar, angive et minima, hvor et negativt filtersvar vil angive et maxima, som angivet i ligning \eqref{laplaceblob}. Der ønskes at identificere ekstremaer i $DoG$ billederne, da de vil angive forekomster af blobs. For hver pixel, sammenlignes et $3\times3\times3$ område, som vist figur \ref{fig:difference} (b). Et punkt udvælges som værende et ekstrema, hvis det er det største/mindste iblandt dens 26 naboer.
\\
\\
...
\label{dxhat}
\end{equation}
Lowe foreslår at værdier af $D(\hat{x})$ under 0.03 fjernes. Metoden vil også have et positivt svar overfor kanter, da to meget forskellige egenværdier, vil resultere i et stærkt svar.
