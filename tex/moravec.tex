...
\begin{figure}[H]
    ...
    \label{fig:moravec}
     ...
     \vspace{-2.5em}
  \end{figure} \noindent   
Af de otte skift genereres otte intensitetsvariationer $E(u,v)$ ift. det originale vindue. Den mindste forskel af disse otte variationer, definere punktets \textit{hjørnestyrke} $C(x,y).$
$$
C(x,y)=min(E(u,v))
$$
