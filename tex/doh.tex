...
\label{deerminantofhessian}
\end{equation}
For blobs ønskes et lokalt ekstrema. Som tidligere beskrevet er dette gældende når fortegnet for de principielle krumninger er ens og derved når Hessian matricens egenværdier er af samme fortegn:
\begin{equation}
\begin{split}
\text{indikator} = 
\begin{cases}
